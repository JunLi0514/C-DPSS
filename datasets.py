...
def cifar10_dataloaders(batch_size=128, data_dir = '/datasets2', normalize=None):
...
def cifar10_dataloaders_subset(batch_size=128, data_dir='datasets/cifar10', normalize=None, number_samples=None):
